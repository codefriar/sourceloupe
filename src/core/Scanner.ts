...
export default class Scanner {
     ...
     * Most cases it's sourcePath (the location of the target source) and a rule array (an array of all rule instances
     ...
     * The result object references the rule instance, syntax node, and other related objects for use in getting more
     ...
     * @param sourceCode The source to be scanned.
     *  Useful when there is a use case for scanning multiple targets for debugging
     * @param language The language to be used for the scan.
     *  Default to Apex
     */
